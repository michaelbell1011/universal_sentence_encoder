...
def api_test():
    ...
    # train_response = requests.post(testing_configs.train_endpoint, json=training_object, timeout=30)
    train_response = requests.post(testing_configs.train_endpoint, json=sample_data.train_obj, timeout=5)  # uses spoof data for testing
    ...
    # predict_response = requests.post(testing_configs.predict_endpoint, json= predict_object, timeout=30)
    predict_response = requests.post(testing_configs.predict_endpoint, json= sample_data.predict_obj, timeout=5)  # uses spoof data for testing
    ...
    api_classify_accur.evaluate(sample_data.labels, predict_response.json())  # uses dummy data above
