...
# First thing to do is select the appropriate model here:
# the script currently filters the dataset to the "big3" classes:
...
# Input must be list/array of 1+ string(s).
...
# This block is unneeded since we are not working with this class
...
# evaluate a saved model with testing data
